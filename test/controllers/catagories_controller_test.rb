...
class CatagoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create catagory" do
    assert_difference("Catagory.count") do
      post catagories_url, params: { catagory: { name: @catagory.name, type: @catagory.type } }
    end
  ...
  test "should update catagory" do
    patch catagory_url(@catagory), params: { catagory: { name: @catagory.name, type: @catagory.type } }
